...
import { Caja, Categoria, FetchOptions, FormaPago, Impuesto, MotivoNota, TipoComprobante, TipoDocumento, TipoMoneda, TipoMovimiento, TipoMovimientoCaja, TipoOperacion, UnidadMedida } from "../types"
