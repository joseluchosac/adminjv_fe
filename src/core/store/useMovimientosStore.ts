...
const movimientosStoreInit = {
  camposMovimiento: [
    ...
    // {show: true, orderable: false, order_dir:"", field_name: "correlativo", field_label:"Correlativo",},
    ...
    {show: false, orderable: true, order_dir:"", field_name: "observacion", field_label:"Observacion",},
    ...
    {show: false, orderable: true, order_dir:"", field_name: "updated_at", field_label:"Actualizado",},
  ],
