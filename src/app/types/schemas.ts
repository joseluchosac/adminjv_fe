...
export const userFormSchema = z.object({
  ...
  nombres: z.string().min(2, "Minimo 2 caracteres").max(50, "Máximo 50 caracteres"),
  apellidos: z.string().min(2, "Minimo 2 caracteres").max(50, "Máximo 50 caracteres"),
  username: z.string().min(2, "Minimo 2 caracteres").max(20, "Máximo 20 caracteres"),
...
export const registerFormSchema = z.object({
  ...
  username: z.string().min(2, "Minimo 2 caracteres"),
  email: z.string().email("Formato del email no válido")
    .optional().or(z.literal('')),
  password: z.string().min(6, "La contraseña debe tener al menos 6 caracteres"),
  confirm_password: z.string(),
