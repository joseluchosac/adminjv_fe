...
import { MovimientoFormDetalle } from "../../../app/types";
...
export const useMovimientos = () => {
  ...
  const agregarProducto = (item: MovimientoFormDetalle) => {
    const {detalle} = context.movimientoForm.getValues()
    ...
    context.movimientoForm.setValue("detalle", nuevoDetalle, {shouldDirty: true})
  }
